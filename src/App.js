...
import Lab3Page from './pages/Lab3Page'; // Import nowego komponentu Lab3Page
...
const menuItems = [
  ...
  { id: 4, label: "Laboratorium 3", url: "/lab3", urlPattern: "/lab3", element: <Lab3Page /> } // Nowa pozycja menu
];
